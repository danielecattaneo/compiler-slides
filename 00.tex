...
\begin{frame}[t]{About the dragon}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[height=.3\paperheight]{img/00/red_dragon_book.jpg}
    \hspace{2em}
    \includegraphics[height=.3\paperheight]{img/00/green_dragon_book.jpg}
    \hspace{2em}
    \includegraphics[height=.3\paperheight]{img/00/purple_dragon_book.jpg}
  \end{center}
\end{frame}
%--- Next Frame ---%
